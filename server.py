...
# data = pd.read_csv("aircon_train.csv")

# cols_with_nonempty = data.columns[data.notna().any()].tolist()[1:]
# X = data[cols_with_nonempty]
...
def data():
    ...
    test_data = pd.read_csv("aircon_test.csv")
